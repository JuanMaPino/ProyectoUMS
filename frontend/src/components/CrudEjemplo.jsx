...
import FormModal from '../components/table/ModalBeneficiario';
import ViewModal from '../components/table/ViewBeneficiario';
import CardItem from './table/CardItem'; // Asegúrate de importar tu componente de tarjeta adecuadamente
        ...
        <div>
            ...
            {filteredData.length === 0 ? (
                ...
                <div>
                                        ...
                                        <TableCell label="Acciones">
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`rounded-lg transition-colors text-white bg-gradient-to-r from-violet-400 to-blue-500 hover:from-violet-600 hover:to-blue-600 p-2`}
                                                >
                                                    <RiPlaneFill />
                                                </button>
                                                <button
                    ...
                    {/* Mostrar tarjetas en pantallas medianas y pequeñas */}
