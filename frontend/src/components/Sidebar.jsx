                ...
                {category.links.map((link) => (
                  <li key={link.name}>
                    <NavLink
                      ...
                      dark:hover:text-black transition-all duration-200 ease-in-out hover:font-bold hover:bg-gradient-to-r from-blue-200 to-blue-500
                       hover:from-blue-300 hover:to-blue-700 w-100${isActive ? 'text-blue-500 font-bold bg-gradient-to-r from-blue-200 to-blue-500 hover:from-blue-300 hover:to-blue-700' : ''} ${activeMenu ? 'text-base' : 'text-sm'} rounded-md `}>
                      {link.icon}
