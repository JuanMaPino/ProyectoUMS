...
const APIPermisos = 'https://localhost:3002/permisos'

export const ObtenerTodosLosPermisos =() => axios.get(`${API}/`)
...
export const getAllRolesRequest = () => axios.get(`${APIPermisos}/`);
